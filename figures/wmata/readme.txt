...
oocalc Historical\ Rail\ Ridership\ By\ Station.txt (it's tricky to get it to load txt as a spreadsheet in File|Open)
	...
	took about 20 min
	transform.py
	upload to openheatmap.com
	recolored with Gimp
	pasted capitol image from AOC website
	drew in metro lines with Gimp
	
	take the original CSV and transpose it in oocalc
	upload to Google Fusion Tables
	cut the legend up to make labels for each of the lines
